...
- **Топка (ред. 3):** глухе шамотне дно (без колосника й зольника); primary — два овальні отвори в передній плиті під дверцятами з ковзною заслінкою; secondary — нижній вхід спереду (щілина з повзуном) → профільний канал під днищем між ніжками → два задні підігрівальні стояки → поперечна нержавіюча труба Ø32 з отворами Ø3–5 мм під бафлем (кількість і Ø рахуються від обсягу топки); air-wash — суцільна щілина над склом із флоп-заслінкою та боковою ручкою. На фасаді три ручки: primary, нижній вхід secondary і дверцята.
