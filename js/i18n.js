...
export const STR = {
  uk: {
    ...
    handleColor: 'Колір ручки дверцят', controlColor: 'Колір службових ручок',
    ...
    washAsSecondary: 'Air-wash як вторинне повітря', tertiaryEnabled: 'Третинне повітря (tertiary)', tertiaryHoles: 'Отворів tertiary', catalystEnabled: 'Каталізатор (honeycomb)',
    ...
    autoOptimize: 'Підібрати оптимум', optimizationDone: 'Оптимальний варіант застосовано', optimizeHint: 'Система перебрала висоту, кут і зазор бафля та приток для поточного режиму.',
  ...
  en: {
    ...
    handleColor: 'Door handle color', controlColor: 'Service handle color',
    ...
    washAsSecondary: 'Air-wash as secondary air', tertiaryEnabled: 'Tertiary air', tertiaryHoles: 'Tertiary holes', catalystEnabled: 'Catalyst (honeycomb)',
    ...
    autoOptimize: 'Find optimum', optimizationDone: 'Optimum applied', optimizeHint: 'The system searched baffle height, angle, front gap and airflow for the current mode.',
