...
export const STR = {
  uk: {
    ...
    showFirebrick: 'Шамот', showBaffle: 'Бафль', showAirChannels: 'Повітряні канали', showChimney: 'Димохід', sectionView: 'Переріз (розріз)', showGrid: 'Сітка / осі',
  ...
  en: {
    ...
    showFirebrick: 'Firebrick', showBaffle: 'Baffle', showAirChannels: 'Air channels', showChimney: 'Chimney', sectionView: 'Cross-section', showGrid: 'Grid / axes',
