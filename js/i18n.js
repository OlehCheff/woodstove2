...
export const STR = {
  uk: {
    ...
    secPhys: 'Фізика v3', kEff: 'ККД', kKw: 'Потужність', kBurn: 'Горіння', kDraft: 'Тяга / топка',
    ...
    secFlow: 'Airflow / потоки', flowVisible: 'Показувати потоки', flowAnimated: 'Анімувати потоки',
    secTest: 'Test Burn / тестове горіння', moisture: 'Вологість дров', load: 'Маса закладки', measuredBurn: 'Фактичне горіння',
    flueTemp: 'Температура димоходу', stoveTemp: 'Температура верху', glassTemp: 'Температура скла', smokeOpacity: 'Непрозорість диму',
    saveTest: 'Зберегти тест', predicted: 'Прогноз', measured: 'Факт', error: 'Відхилення',
  ...
  en: {
    ...
    secPhys: 'Physics v3', kEff: 'Efficiency', kKw: 'Output', kBurn: 'Burn time', kDraft: 'Draft / firebox',
    ...
    secFlow: 'Airflow / flow paths', flowVisible: 'Show flow paths', flowAnimated: 'Animate flow',
    secTest: 'Test Burn', moisture: 'Wood moisture', load: 'Fuel load', measuredBurn: 'Measured burn',
    flueTemp: 'Flue temperature', stoveTemp: 'Stove top temperature', glassTemp: 'Glass temperature', smokeOpacity: 'Smoke opacity',
    saveTest: 'Save test', predicted: 'Predicted', measured: 'Measured', error: 'Error',
