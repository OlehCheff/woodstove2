...
export const STR = {
  uk: {
    ...
    saveTest: 'Зберегти тест', predicted: 'Прогноз', measured: 'Оцінка тесту', error: 'Відхилення від моделі',
  ...
  en: {
    ...
    saveTest: 'Save test', predicted: 'Predicted', measured: 'Test-derived', error: 'Model deviation',
